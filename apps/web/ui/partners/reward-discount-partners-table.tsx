...
export function PartnersTable({
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center rounded-xl border-[6px] border-neutral-100 bg-white py-8">
  ...
  if (partnersCount === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-3 rounded-xl border-[6px] border-neutral-100 bg-neutral-50 py-10">
