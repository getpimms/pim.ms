      ...
      <div className="p-5">
        <div className="relative flex flex-col overflow-hidden rounded-xl border-[6px] border-neutral-200 p-4 md:p-6">
          ...
          <div className="xs:flex-row relative flex flex-col items-center gap-2">
            <div className="xs:w-60 h-10 w-full rounded-xl border-[2px] border-neutral-300 bg-neutral-50" />
            <Button
        ...
        <div className="mt-4 grid gap-2 sm:h-32 sm:grid-cols-3">
          <div className="h-full w-full rounded-lg border-[6px] border-neutral-100 bg-neutral-50 sm:col-span-2" />
          <div className="h-full w-full rounded-lg border-[6px] border-neutral-100 bg-neutral-50" />
        </div>
        <div className="mt-4">
          <div className="h-10 w-full rounded-lg border-[6px] border-neutral-100 bg-neutral-50" />
