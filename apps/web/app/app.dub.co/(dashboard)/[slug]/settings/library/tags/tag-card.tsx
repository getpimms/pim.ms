        ...
        <div className="flex items-center gap-5 sm:gap-8 md:gap-12">
          {linksCount !== undefined && (
            <Link
              ...
              className="whitespace-nowrap rounded-xl border-[2px] border-neutral-100 bg-neutral-50 px-2 py-0.5 text-sm text-neutral-800 transition-colors hover:bg-neutral-100"
            >
