...
const ImportProgramForm = ({ register, watch, setValue }: FormProps) => {
  ...
  return (
    <div className="space-y-6">
            ...
            {isLoadingCampaigns ? (
              ...
              <>
                <select
                  ...
                  className="block w-full appearance-none rounded-xl border-[2px] border-neutral-100 bg-white px-3 py-2 pr-8 text-sm text-neutral-900 focus:border-neutral-500 focus:outline-none focus:ring-neutral-500"
                >
      ...
      {selectedCampaign && (
        <div className="grid grid-cols-2 gap-6 rounded-xl border-[6px] border-neutral-200 bg-neutral-50 p-6">
          <div>
