...
export function Switch({
  ...
  const switchRoot = (
    <SwitchPrimitive.Root
      ...
      className={cn(
        "radix-state-checked:bg-[#B3E4FF] radix-state-unchecked:bg-neutral-200 relative inline-flex h-4 w-8 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out",
